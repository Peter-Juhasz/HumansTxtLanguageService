using HumansTxtLanguageService.CodeFixes;
...
namespace HumansTxtLanguageService
{
    ...
    [Name("Humans.txt Suggested Actions")]
    [ContentType(HumansTxtContentTypeNames.HumansTxt)]
    internal sealed class HumansTxtSuggestedActionsSourceProvider : ISuggestedActionsSourceProvider
    {
...
#pragma warning restore 649
        ...
        public ISuggestedActionsSource CreateSuggestedActionsSource(ITextView textView, ITextBuffer textBuffer)
        {
            return textBuffer.Properties.GetOrCreateSingletonProperty(
                creator: () => new HumansTxtSuggestedActions(
                    textView, textBuffer,
        ...
        private sealed class HumansTxtSuggestedActions : ISuggestedActionsSource
        {
            public HumansTxtSuggestedActions(
